    ...
    <div className="w-full h-full lg:shadow-custom2 bg-white lg:rounded-2xl p-6">
      ...
      <div className="mt-6">
        <div className="">
          ...
          <h2 className="font-semibold mt-2">Elizabeth Odiai</h2>
        </div>
        <div className="mt-4">
          <h4 className="text-[#787878] text-sm">Email Address</h4>
          <h2 className="font-semibold mt-2">Lizziefavour@gmail.com</h2>
        </div>
        <div className="mt-4">
          <h4 className="text-[#787878] text-sm">Phone Number</h4>
          <h2 className="font-semibold mt-2">917-671-5839</h2>
        </div>
        <div className="mt-4">
          <h4 className="text-[#787878] text-sm">Country</h4>
          <h2 className="font-semibold mt-2">United States</h2>
        </div>
        <div className="mt-4">
