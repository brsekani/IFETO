...
const security = () => {
  ...
  return (
    <div className="w-full h-full lg:shadow-custom2 bg-white lg:rounded-2xl p-6">
      ...
      <div className="lg:mt-10 mt-8 w-full flex lg:justify-end justify-center">
        <button
          className="outline-none cursor-pointer flex items-center gap-2.5 text-[#E53E3E]"
          onClick={handleDeleteInitiate}
        >
          <Trash2 className=" w-[18px]" /> <span className="text-lg font-semibold">Delete Account</span>
        </button>
      </div>

      {/* Reason Modal */}
      <Modal isOpen={showReasonModal} onClose={closeModals}>
      ...
      <Modal isOpen={showConfirmModal} onClose={closeModals}>
        <div className="flex justify-center items-center flex-col">
          ...
          <p className="mt-4 text-base text-light text-center">
            This action is <span className="text-black font-bold">permanent</span>.
            All your personal data, saved addresses, and shipping history will be
            permanently removed.
          </p>
          <p className="mt-2 text-base text-[#5A5A5A] text-center">
            You will{" "}
            <span className="text-black font-bold">not be able to recover</span>{" "}
            your account after deleting it.
          </p>
        </div>

        <label className="block font-medium text-sm mt-4" htmlFor="password">
          Password
        </label>
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={
              isDeleting || !deleteFormik.isValid || !deleteFormik.values.password
            }
          >
      ...
      <Modal isOpen={showSuccessModal}>
        <div className="flex justify-center items-center flex-col">
          ...
          <p className="mt-4 text-base text-light text-center">
            We're sad to see you go. If you ever return, you can create a new
            account anytime.
          </p>
        </div>
        <button
